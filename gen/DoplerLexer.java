...
public class DoplerLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"CR", "LF", "QUESTION_KEY", "QUESTION", "TYPE_KEY", "RANGE_KEY", "CARDINALITY_KEY", 
			"CONSTRAINT_RULE_KEY", "VISIBLE_RELEVANT_KEY", "DOPLER_KEY", "WS_DEFAULT", 
			"WS_JSON", "ALLOW", "DISALLOW", "ISTAKEN", "GETVALUE", "EQUALS", "GREATER_THAN", 
			"LESS_THAN", "LESS_EQUALS", "GREATER_EQUALS", "OR", "AND", "XOR", "PIPE", 
			"SET", "NOT", "MINUS", "LPAREN", "RPAREN", "LBRACE", "RBRACE", "COLON", 
			"IF", "ANPERSAND", "PERCENT", "COMMA", "SEMICOLON", "DQ", "BooleanLiteralExpression", 
